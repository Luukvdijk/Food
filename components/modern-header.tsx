...
export function ModernHeader({ onFiltersToggle, hasActiveFilters }: ModernHeaderProps) {
      ...
      <div className="w-full py-6 px-8 relative z-10">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="flex items-center gap-2 text-white font-medium text-lg hover:text-[#eee1d1] transition-colors"
          >
            <Filter className="h-5 w-5" />
            Filters
            {hasActiveFilters && <span className="bg-[#e75129] text-white text-xs px-2 py-1 rounded-full">Actief</span>}
          </button>
