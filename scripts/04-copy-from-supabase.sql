-- Eerst de tabellen aanmaken als ze nog niet bestaan
...
-- Voeg de recepten data toe (dezelfde als in Supabase)
INSERT INTO recepten (id, naam, beschrijving, bereidingstijd, moeilijkheidsgraad, type, seizoen, tags, afbeelding_url, bereidingswijze, personen)
VALUES 
  (
    1,
